            ...
            <View style={[styles.shell, desktop && styles.shellDesktop]}>
              ...
              <View style={[styles.layout, desktop && styles.layoutDesktop]}>
                ...
                <View style={[styles.card, desktop && styles.cardDesktop]}>
                  ...
                  >
                    <Text style={styles.primaryText}>{submitting ? "Creando..." : "Continuar"}</Text>
                  ...
                  <Text style={styles.note}>
                    Tu cuenta se crea de forma segura y se conecta automáticamente con EcoTracker.
                  </Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  error:{color:colors.danger,fontSize:9,lineHeight:14,textAlign:"center",marginTop:12},
