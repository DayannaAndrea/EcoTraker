...
const transportOptions = [
  { id:"car", label:"Automóvil", factor:0.18 },
  { id:"bus", label:"Bus", factor:0.08 },
  { id:"motorcycle", label:"Moto", factor:0.11 },
  { id:"bike", label:"Bicicleta", factor:0 },
  { id:"walk", label:"A pie", factor:0 }
];
          ...
          <Animated.View style={[styles.shell,desktop&&styles.shellDesktop,{opacity:fade,transform:[{translateY:rise}]}]}>
            ...
            <View style={styles.titleRow}>
              <View style={{flex:1}}>
                ...
                <Text style={styles.subtitle}>Registra un desplazamiento y consulta su impacto estimado antes de conectarlo con el backend.</Text>
              </View>
            ...
            <View style={[styles.layout,desktop&&styles.layoutDesktop]}>
              <View style={[styles.formCard,desktop&&styles.formDesktop]}>
                ...
                <Pressable style={({pressed})=>[styles.saveButton,pressed&&styles.pressed]} onPress={saveDemo}>
                  <View><Text style={styles.saveEyebrow}>REGISTRO</Text><Text style={styles.saveText}>Guardar viaje</Text></View>
